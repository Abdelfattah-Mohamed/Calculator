...
public class SanityTest {
	...
	/**
	 * This test should insert 5 inputs then save, then load the program and then
	 * check the history
	 */
	@org.junit.Test
	...
	/**
	 * This test should insert 3 inputs and then do prev, then save and load the
	 * program, and then print the results
	 */
	@org.junit.Test
	...
	/**
	 * This test should insert 3 operations then get the results for al of them, and
	 * it should test boundaries null at far next and prev
	 */
	@org.junit.Test
